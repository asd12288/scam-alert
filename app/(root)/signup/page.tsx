...
export const metadata: Metadata = {
  ...
  description:
    "Create a free Scam Protector account to access personalized scam protection, saved reports, and alerts about dangerous websites.",
  keywords: [
    "sign up",
    "create account",
    "register",
    ...
    <>
      ...
      <JsonLd<any>
        item={{
          ...
          "@type": "WebPage",
          name: "Create a Scam Protector Account",
          description:
            "Sign up for a free account to access personalized scam protection features and saved reports.",
          mainEntityOfPage: {
            "@type": "WebPageElement",
            name: "Registration Form",
            description:
              "Form for creating a new user account on Scam Protector.",
          },
        }}
      />
