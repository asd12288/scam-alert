          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-1/2">
              ...
              <Link
                ...
                className="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-medium flex items-center gap-2 max-w-xs justify-center text-lg shadow-md"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-lg font-medium inline-flex items-center gap-2 text-lg shadow-md"
          >
            <Download className="w-5 h-5" />
