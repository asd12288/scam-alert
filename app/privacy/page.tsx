...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Scam Protector collects, uses, and protects your personal information when using our scam detection services.",
  keywords: [
    "privacy policy",
    "data protection",
    ...
    <>
      ...
      <JsonLd<any>
        item={{
          ...
          name: "Privacy Policy",
          description:
            "Learn how Scam Protector collects, uses, and protects your personal information.",
          mainEntityOfPage: {
            "@type": "WebPageElement",
            name: "Privacy Policy Document",
            description:
              "Detailed information about data collection, usage, security practices, and user privacy rights at Scam Protector.",
          },
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                you interact with our service, including your search history and
                usage patterns.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              please contact us at privacy@scam-protector.com.
            </p>
          </section>
        </div>
      </div>
